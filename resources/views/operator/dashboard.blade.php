    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            <div class="p-4 flex items-center h-48 mb-4 rounded-lg border-2 border-gray-200 bg-gray-50 dark:bg-gray-800">
                <div class="flex items-center">
                    <div class="w-40 h-40 rounded-full overflow-hidden">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Default_pfp.svg/768px-Default_pfp.svg.png"
                            alt="Foto Profil">
                    </div>
                    <div class="ml-6">
            ...
            <div class="flex flex-wrap w-full max-w-8xl space-x-4">
                ...
                <div class="w-auto flex rounded-lg border-2 border-gray-200 h-96 rounded bg-gray-50 dark:bg-gray-800"
                    style="width: 65.2%">
                    {{-- Chart --}}
                    <div class="max-h-sm h-full max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
