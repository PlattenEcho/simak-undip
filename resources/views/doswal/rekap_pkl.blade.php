...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
            <form class="flex items-center" action="{{ route('doswal.viewRekapPKL') }}" method="GET">            
            ...
            <div class="p-3">        
                <a href="{{ route('doswal.cetakRekapPKL', [$tahun1, $tahun2]) }}" type="button" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cetak PDF</a>
            </div>
        </div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="text-center bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover-bg-gray-600">
                        @for ($tahun = $tahun1; $tahun <= $tahun2; $tahun++)
                        <td class="px-6 py-4">
                            <a href="{{ route('doswal.viewSudahPKL', $tahun) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ $sudahPKL[$tahun] }}</a>
                        </td>
                        <td class="px-6 py-4">
                            <a href="{{ route('doswal.viewBelumPKL', $tahun) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{{ $belumPKL[$tahun] }}</a>
                        </td>
                        @endfor
                    </tr>
                    </tbody>
