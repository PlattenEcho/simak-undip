            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover-bg-gray-600">
                        ...
                        <td>
                            <a href="#" data-modal-target="verifikasi-modal-{{ $skripsi->id_skripsi }}" data-modal-toggle="verifikasi-modal-{{ $skripsi->id_skripsi }}" class="text-green-400 hover:text-green-100  mr-2">
								<i class="material-icons-outlined text-base">domain_verification</i>
							</a>
							<a href="{{ route('skripsi.viewEditSkripsi', [$skripsi->id_skripsi]) }}" class="text-blue-400 hover:text-blue-100 mx-2">
								<i class="material-icons-outlined text-base">edit</i>
							</a>
							<a href="#" data-modal-target="delete-modal-{{ $skripsi->id_skripsi }}" data-modal-toggle="delete-modal-{{ $skripsi->id_skripsi }}" class="text-red-400 hover:text-red-100 ml-2">
