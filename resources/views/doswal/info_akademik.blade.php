        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <div class="inline-block">
                @if (count($skripsi[$i]) > 0)
                    ...
                    <a data-modal-target="modal-{{ $i }}" data-modal-toggle="modal-{{ $i }}" type="button" class="text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-400 dark:hover:bg-green-300 dark:focus:ring-green-400">a</a>
                    @endif
