...
@section('body')
<section class="bg-gray-50 dark:bg-gray-900"> <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto
    md:h-screen lg:py-0"> <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0
    dark:bg-gray-800 dark:border-gray-700">
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        <div>
            <div class="flex flex-col items-center mb-6"> <a href="#"
                ...
                <img class="w-10 h-10 mr-2"
                    ...
                    alt="logo">
                </a> <a href="" class="flex items-center text-2xl font-bold text-gray-900 dark:text-white"> SIMAK Undip
                    </a> </div> <h1
                ...
                role="alert"> <span class="font-medium">Log-In Gagal!</span> <p>Silakan Coba Kembali.</p>
            </div>
            @endif
            ...
            <div class="p-4 mr-2 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400"
                role="alert"> <span class="font-medium">Log Out Berhasil!</span> <p>Silakan Login Kembali.</p>
                </div>
                @endif
            </div>
            ...
            <div class="mt-2 mb-2">
                <div class="captcha" style="display: flex; align-items: center;">
                    ...
                    <button type="button" class="ml-3 btn btn-danger reload" id="reload">
                        &#x21bb;
                    </button>
                </div>
            </div>
            ...
            <div class="form-group mb-2">
                <input type="text" class="form-control border-gray-300 text-gray-900 sm:text-sm rounded-lg"
