                ...
                <div id="accordion-collapse-body-{{ $khs->semester }}" class="hidden" aria-labelledby="accordion-collapse-heading-{{ $khs->semester }}">
                    <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <a data-popover-target="popover-delete" href="#" data-modal-target="delete-modal-{{ $khs->id_khs }}" data-modal-toggle="delete-modal-{{ $khs->id_khs }}"
                                ...
                                <div class="relative p-4 w-full max-w-md max-h-full">
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        ...
                                        <div class="p-4 md:p-5 text-center">
                                            ...
                                            <form action="{{ route('khs.delete2', [$khs->id_khs]) }}" method="post">
                                                @csrf
