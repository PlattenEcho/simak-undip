...
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
            ...
            <form enctype="multipart/form-data" class="space-y-4 md:space-y-6" method="POST" autocomplete="on" action="{{ route('irs.update', [$irs->id_irs]) }}" >
            @csrf
            ...
            <div class="m-auto">
                ...
                <a href="{{ route('irs.viewEditIRS', [$irs->id_irs]) }}"
